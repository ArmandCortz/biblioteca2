...
<html lang="en">
    <head>
        ...
        <title>INSTITUTO NACIONAL "GENERAL MANUEL JOSE ARCE"</title>
        <!-- CSS -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong></strong>INSTITUTO NACIONAL
                            <BR> "GENERAL MANUEL JOSE ARCE"</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h1>Biblioteca <P>INARCE</P> </h1>

                               <img src="images/logoBiblioteca.png" width="100px" height="100px">
