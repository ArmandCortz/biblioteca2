            ...
            <div class="container-fluid">
             <br>
                ...
                <h1 class="page-header">
                            <small><img src="images/logo.jpg"></small> Estudiantes 
                        </h1>
                <!-- /.row -->
    <section>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
           ...
           <td colspan="2"><input type="text" class="form-control" required readonly id="id-prod" name="id-prod" readonly="readonly" style="visibility:hidden; height:5px;"/></td>
                    ...
                    <tr>
                        <td>Carnet: </td>
                        <td><input type="text" class="form-control" required name="carnet" id="carnet" maxlength="100"/></td>
                    </tr>
                    <tr>
                        <td>Nombre:</td>
              <td><input type="text" class="form-control" required name="nombre" id="nombre" maxlength="100"/></td>
                    ...
                    <tr>
                        <td>Apellidos:</td>
              <td><input type="text" class="form-control" required name="apellidos" id="apellidos" maxlength="100"/></td>
                    </tr>
                     <tr>
                        <td>Email:</td>
