...
<head>
    ...
    <title>Biblioteca INARCE| Panel Administracion</title>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <h1 class="page-header">
                <small><img src="images/logo.jpg"></small> Listado de Libros
            </h1>
            <!-- /.row -->
            <section>
                <table border="0" align="left">
                    <tr>
                        ...
                        <td>&nbsp; &nbsp;</td>
                        <td width="335"><input type="text" placeholder="Busca por Nombre de libro" id="bs-prod"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header" style="background:#839ca9;">
                            <button type="button" class="close" style="color:white; font-size: 20px;"
                                data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" style="color:white;" id="myModalLabel"><b>Mantenimiento de
                                    Libros</b></h4>
                        </div>
                        <form id="formulario" class="form-group" onsubmit="return agregaLibro();">
                            <div class="modal-body">
                                <table border="0" width="100%">
                                    <tr>
                                        <td colspan="2"><input type="text" class="form-control" required readonly
                                                id="id-prod" name="id-prod" readonly="readonly"
                                                style="visibility:hidden; height:5px;" /></td>
                                    </tr>
                                    <tp r>
                                        <td width="150">Proceso: </td>
                                        <td><input type="text" class="form-control" required readonly id="pro"
                                                name="pro" /></td>
                                    </tp>
                                    <!-- <tr>
                        <td>Foto: </td>
                        <td><input type="text" class="form-control" required name="foto" id="foto" maxlength="100"/></td>
                                    ...
                                    <tr>
                                        <td>Nombre: </td>
                                        <td><input type="text" class="form-control" required name="nombre" id="nombre"
                                                maxlength="100" /></td>
                                    </tr>
                                    <tr>
                                        <td>Descripcion: </td>
                                        <td><input type="text" class="form-control" required name="descripcion"
                                                id="descripcion" maxlength="100" /></td>
                                    </tr>
                                    <tr>
                                        <td>Disponible: </td>
                                        <td><input type="text" class="form-control" required name="disponible"
                                                id="disponible" maxlength="100" /></td>
                                    </tr>
                                    <tr>
                                        <td>Categoria:</td>
                                        <td>
                      ...
                      ?>
                                    ...
                                    <tr>
                                        <td>Fecha Ingreso: </td>
                                        <td><input type="date" class="form-control" required name="fecha" id="fecha" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Estante: </td>
                                        <td><input type="text" class="form-control" required name="descarga"
                                                id="descarga" maxlength="250" /></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <div id="mensaje"></div>
